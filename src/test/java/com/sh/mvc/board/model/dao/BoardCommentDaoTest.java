...
public class BoardCommentDaoTest {
    ...
    public void test5() {
        ...
        long id = 1;
        BoardComment boardComment = boardDao.findCommentById(session, id);
        ...
        // then
        BoardComment boardComment1 =boardDao.findCommentById(session, id);
        assertThat(boardComment1).isNull();
    }
}
