            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form name="memberRegisterFrm" method="post" class="space-y-4 md:space-y-6">
                    <div class="relative">
                        ...
                        <span class="guide ok text-blue-700 absolute hidden top-10 end-1">이 아이디는 사용가능합니다.</span>
                    ...
                    <div>
                        ...
                        <input type="password" name="password" id="password" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" value="1234!a" required>
                    </div>
                    <div>
                        ...
                        <input type="password" name="confirm-password" id="confirm-password" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" value="1234!a" required>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="phone" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="(-) 없이 입력하세요." value="01012348888">
                    </div>
                    <fieldset>
